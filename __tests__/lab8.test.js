describe('Basic user flow for SPA ', () => {
  ...
  it('Test3: Clicking first <journal-entry>, new URL should contain /#entry1', async () => {
    ...
    await page.click('journal-entry:nth-of-type(1)');
    expect(page.url()).toBe('http://127.0.0.1:5500/#entry1');
  });

  it('Test4: On first Entry page - checking page header title', async () => {
    // implement test4: Clicking on the first journal entry should update the header text to “Entry 1” 
    let header = await page.$eval('h1', (entry) => {
  ...
  it('Test5: On first Entry page - checking <entry-page> contents', async () => {
    /*
      ...
      */
    let entry = await page.$eval('entry-page', (entryPage) => {
  ...
  it('Test8: On Settings page - checking page header title', async () => {
    ...
    let header = await page.$eval('h1', (settings) => {
  ...
  it('Test12: On Home page - checking page header title', async () => {
    // implement test8: Clicking on the settings icon should update the header to be “Settings”
    let header = await page.$eval('h1', (home) => {
  ...
  it('Test18: Clicking tenth <journal-entry>, new URL should contain /#entry10', async () => {
    await page.click('journal-entry:nth-of-type(10)');
    expect(page.url()).toBe('http://127.0.0.1:5500/#entry10');
  });

  // create your own test 19
  it('Test19: On tenth Entry page - checking page header title', async () => {
    let header = await page.$eval('h1', (entry) => {
      return entry.innerHTML;
    });
  ...
  it('Test20: On tenth Entry page - checking <entry-page> contents', async () => {
    let entry = await page.$eval('entry-page', (entryPage) => {
      return entryPage.entry;
    });
    let expected = { 
